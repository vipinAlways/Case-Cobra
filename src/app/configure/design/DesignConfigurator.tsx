...
const DesignConfigurator = ({
  ...
  return (
    <div className="relative mt-20 mb-20 grid-cols-1 grid lg:grid-cols-3 pb-20">
      <div
        ref={containerRef}
        className=" relative h-[37.5rem] overflow-hidden col-span-2 w-full mac-w-full items-center flex justify-center rounded-lg border-2 border-dashed border-gray-300 p-12 text-center focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
      >
          ...
          <div className="px-8 pb-12 pt-8">
            ...
            <div className="relative mt-4 h-full flex flex-col justify-between">
              <div className="flex flex-col gap-6">
                ...
                <div className="relative flex flex-col gap-3 w-full z-50 ">
                  <Label>Model</Label>
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent>
                      {MODELS.options.map((model) => (
                        <DropdownMenuItem
                          key={model.label}
                          className={cn(
                            "flex text-sm gap-1 items-center p-1.5 cursor-default hover:bg-zinc-100 bg-zinc-50 ",
                            {
                              "bg-zinc-300":
                      ...
                      <div className="mt-3 space-y-4">
                        {selectableOptions.map((option) => (
                          ...
                          >
                            ...
                            <RadioGroup.Description
                              as="span"
                              className="mt-2 flex text-sm sm:ml-4 sm:mt-0 sm:flex-col sm:text-right z-10"
                            >
        ...
        <div className="w-full px-8 h-16 bg-white ">
          <div className="h-px w-full bg-zinc-200">
            <div className="flex justify-end items-center w-full h-full">
              <div className="flex gap-6 w-full items-center mt-16 ">
