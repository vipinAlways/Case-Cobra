-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('fulfilled', 'shipped', 'awaitung_shipment');
...
-- CreateEnum
CREATE TYPE "CaseColors" AS ENUM ('black', 'blue', 'rose');
...
CREATE TABLE "Order" (
    ...
    "status" "OrderStatus" NOT NULL DEFAULT 'awaitung_shipment',
